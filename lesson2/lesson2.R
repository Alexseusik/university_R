...
qqplot(qlnorm(ppoints(X)), X, main = "QQ-діаграма для Логнормального Розподілу", xlab = "Теоретичні квантилі", ylab = "Зразкові квантилі")
abline(a = 0, b = 1, col = "red")

qqplot(qexp(ppoints(X)), X, main = "QQ-діаграма для Експоненційного Розподілу", xlab = "Теоретичні квантилі", ylab = "Зразкові квантилі")
abline(a = 0, b = 1, col = "red")

qqplot(qchisq(ppoints(X), df = 5), X, main = "QQ-діаграма для χ² Розподілу", xlab = "Теоретичні квантилі", ylab = "Зразкові квантилі")
abline(a = 0, b = 1, col = "red")
...
QQplot <- function(x, df, K=1000, alpha=0.05) {
  ...
  # Генерація даних для довірчих інтервалів
  ...
  points(chiSquareQ, sx, col = 2) # дані
  segments(chiSquareQ, bots, chiSquareQ, tops, col = 4) # довірчі інтервали
  abline(0, 1, col = 1) # допоміжна лінія
}
